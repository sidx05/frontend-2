...
A modern, scalable backend for the NewsHub platform featuring automated news scraping, straightforward content publishing, and robust moderation controls.

## Features

- **Automated News Scraping**: RSS/HTML scraping from multiple sources every 5 minutes
- **Content Publishing**: Editorial workflow to review and publish articles
- **Content Moderation**: Configurable moderation workflow
...
2. **Content Moderation** - Moderation workflow
3. **Publishing** - Publishes approved articles
...
**NewsHub Backend** - A modern, scalable news platform backend.#   b a c k e n d - 2  
 