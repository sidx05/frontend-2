...
const mongoose_1 = require("../lib/mongoose"); // <-- shared instance
...
// Generate slug and calculate metadata before validation
...
articleSchema.index({ lang: 1, status: 1 }); // Keep old 'lang' field index
exports.Article = mongoose_1.mongoose.model('Article', articleSchema);
